  ...
  return (
    <div className='w-full relative h-auto md:h-[60vh] flex flex-col md:flex-row items-center justify-center py-12 md:py-0'>
       <div className='w-full md:w-[50%] h-auto md:h-[40vh] flex justify-center items-center mb-8 md:mb-0 px-4'>
        <h1 className='font-acron font-semibold text-base sm:text-lg text-[#4C6763] text-center'>© 2025 Rabin Thapa • Nepal</h1>
       </div>
       <div className='w-full md:w-[50%] h-auto md:h-[40vh] px-8 sm:px-12 md:px-46 flex flex-col sm:flex-row gap-8 sm:gap-12 md:gap-16'>
           <div className='space-y-3 sm:space-y-4'>
            ...
            <Link href="https://www.linkedin.com/in/rabin-thapa-a35343260/" target='_blank' > <p className='text-[#4C6763] font-matter hover:text-[#025A4E] cursor-pointer text-sm sm:text-base'>Linkden </p></Link>
